...
export default async function CategoryPage({
  ...
  // Await the params to resolve and get the category value
  ...
  return (
    <div className='bg-white'>
      <div className='mx-auto max-w-2xl px-8 py-8 sm:px-6 sm:py-10 lg:max-w-7xl lg:px-8'>
        <div className='flex justify-between items-center'>
          <h2 className='text-2xl font-bold tracking-tight text-gray-900'>
            Senarai {category} Untuk Dijual
          </h2>
        </div>
